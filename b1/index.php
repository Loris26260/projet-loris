...
// Connexion à la base de données MySQL sur un serveur Oracle
$host = '144.24.194.165/'; // Adresse du serveur Oracle
$dbname = 'Pharmacie';
$user = 'mysql_user'; // Nom d'utilisateur MySQL
$pass = 'mysql_password'; // Mot de passe MySQL
